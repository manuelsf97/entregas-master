...
<body>
    ...
    <div class="brand">Entregas ManuelDW</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Entregas ManuelDW</a>
            </div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Nosotros
                        <strong>Pedidos ManuelDW</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <p><a href = "#"><b>ManuelDW</b></a> es una empresa especializada en procesos de Marketing Digital y Desarrollo, integrando soluciones de Growth Hacking y software a medida.</p> 
