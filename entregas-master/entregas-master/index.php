...
<head>
    ...
    <title>Entregas Manuel DW</title>
...
<body>
    <div class="brand"> <img src="img/logo.png" width="170" heigth="160" alt="" srcset=""> Entregas Manuel DW</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Entregas Manuel DW</a>
            </div>
    ...
    <div class="container">
		...
		<?php 
			$conn = mysqli_connect("localhost","root","","smss-db");
